...
class UrlDispatcher(AbstractRouter, Mapping[str, AbstractResource]):
    ...
    async def resolve(self, request: Request) -> UrlMappingMatchInfo:
        ...
        # Host-matched sub-applications take precedence over path resources in
        # the parent application. Otherwise, a parent route with the same path
        # would be returned before the domain rule is evaluated.
